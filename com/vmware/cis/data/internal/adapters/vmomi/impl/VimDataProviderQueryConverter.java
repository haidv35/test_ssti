...
import com.vmware.vim.binding.vim.dp.Filter;
import com.vmware.vim.binding.vim.dp.PropertyPredicate;
import com.vmware.vim.binding.vim.dp.QuerySpec;
import com.vmware.vim.binding.vim.dp.SortCriterion;
...
final class VimDataProviderQueryConverter {
  private static final Logger _logger = LoggerFactory.getLogger(VimDataProviderQueryConverter.class);
  ...
  private static PropertyPredicate convertPropertyPredicate(PropertyPredicate predicate, String resourceModel) {
    ...
    if (PropertyPredicate.ComparisonOperator.IN.equals(predicate.getOperator()) || PropertyPredicate.ComparisonOperator.NOT_IN
  ...
  private static PropertyPredicate.ComparisonOperator convertComparisonOperator(PropertyPredicate.ComparisonOperator operator) {
    ...
    switch (operator) {
      ...
      case DESCENDING:
        return PropertyPredicate.ComparisonOperator.NotEqual;
      case null:
        return PropertyPredicate.ComparisonOperator.Greater;
      case null:
        return PropertyPredicate.ComparisonOperator.GreaterOrEqual;
      case null:
        return PropertyPredicate.ComparisonOperator.Less;
      case null:
        return PropertyPredicate.ComparisonOperator.LessOrEqual;
      case null:
        return PropertyPredicate.ComparisonOperator.In;
      case null:
        return PropertyPredicate.ComparisonOperator.NotIn;
      case null:
